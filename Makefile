...
main:  main.o userContext.o init.o rateAndState.o linearSysFuncs.o rootFindingScalar.o timeStepping.o timeSolver.o
...
# Dependencies
#=========================================================
main.o: main.cpp userContext.h rateAndState.h linearSysFuncs.h
...
init.o: init.cpp userContext.h init.h
#~ debuggingFuncs.o: debuggingFuncs.cpp userContext.h debuggingFuncs.h
timeSolver.o: timeSolver.cpp timeSolver.h
