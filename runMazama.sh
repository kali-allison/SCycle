#!/bin/bash
#PBS -N stressTests/lm_s1e-12_tau43.8667
#PBS -l nodes=1:ppn=24
#PBS -q tgp
#PBS -V
#PBS -m n
#PBS -k oe
#PBS -e /data/dunham/kallison/eqcycle/nov21_outFiles/lm_s1e-12_tau43.8667.err
#PBS -o /data/dunham/kallison/eqcycle/nov21_outFiles/lm_s1e-12_tau43.8667.out
