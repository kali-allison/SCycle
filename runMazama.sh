#!/bin/bash
#PBS -N qdfd_pl_qd2fd1e-3_fd2qd1e-3_zlab50
#PBS -l nodes=2:ppn=24
#PBS -q tgp
#PBS -V
#PBS -m n
#PBS -k oe
#PBS -e /data/dunham/kallison/scycle/outFiles/qdfd_pl_qd2fd1e-3_fd2qd1e-3_zlab50.err
#PBS -o /data/dunham/kallison/scycle/outFiles/qdfd_pl_qd2fd1e-3_fd2qd1e-3_zlab50.out
