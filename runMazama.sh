#!/bin/bash
#PBS -N plcremeBrulee_blansVW_cycle_Ny201_Nz151
#PBS -l nodes=1:ppn=24
#PBS -q tgp
#PBS -V
#PBS -m n
#PBS -k oe
#PBS -e /data/dunham/kallison/eqcycle/stdoutFiles/plcremeBrulee_blansVW_cycle_Ny201_Nz151.err
#PBS -o /data/dunham/kallison/eqcycle/stdoutFiles/plcremeBrulee_blansVW_cycle_Ny201_Nz151.out
