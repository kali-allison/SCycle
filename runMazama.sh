#!/bin/bash
#PBS -N step3_lmjs_TB_Co5_sN0_dc16e-3_Ny201_Nz585_step3
#PBS -l nodes=1:ppn=24
#PBS -q tgp
#PBS -V
#PBS -m n
#PBS -k oe
#PBS -e /data/dunham/kallison/eqcycle/outFiles/lmjs_TB_Co5_sN0_dc16e-3_Ny201_Nz585_step3.err
#PBS -o /data/dunham/kallison/eqcycle/outFiles/lmjs_TB_Co5_sN0_dc16e-3_Ny201_Nz585_step3.out
