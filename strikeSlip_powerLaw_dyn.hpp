#ifndef STRIKESLIP_POWERLAW_DYN_H_INCLUDED
#define STRIKESLIP_POWERLAW_DYN_H_INCLUDED
...
class StrikeSlip_PowerLaw_dyn: public IntegratorContextWave
{
private:
    // disable default copy constructor and assignment operator
    StrikeSlip_PowerLaw_dyn(const StrikeSlip_PowerLaw_dyn &that);
    StrikeSlip_PowerLaw_dyn& operator=(const StrikeSlip_PowerLaw_dyn &rhs);
