...
% Version 2.99 (2016-07-07)
%
% Copyright (c) 2016, Michael R. Craymer
% All rights reserved.
% Email: mike@craymer.com
%
% A collection of geodetic functions that solve a variety of problems in
% geodesy. Supports a wide range of common and user-defined reference
% ellipsoids. Most functions are vectorized. Most recent version can be
% found at <http://www.craymer.com/software/matlab/geodetic/>. Functions
% include:
%
% Angle Conversions
...
% 2.98 Corrected function name in utm2ell (was ell2utm) and corrected test for
%      points in southern hemisphere when using negative zones.
%      Corrected vectorized computation of E2, improved zone computation and
%      added correction for zero Zones in ell2utm.
%      Corrected comments & help info in cart2euler & euler2cart.
%      Clarified use of mark-to-mark distances in help comments of direct,
%      inverse, DirInv, DirProb & InvProb.
%      Corrected spelling of usage (was useage) in 31 functions.
% 2.99 Added transform for similarity transformation in either left-handed LG
%      coordinate system (default) or right-handed CT coordinate system.
