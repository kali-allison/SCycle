...
% INVERSE  Computes inverse 3D geodetic problem.
%   Determines azimuth, vertical angle and mark-to-mark
%   (chord) distance from 1st station to 2nd given their
%   ellipsoidal coordinates. If az,va are local astronomic,
%   lat,lon must be astronomic. If az,va are local geodetic,
%   lat,lon must be local geodetic.  Non-vectorized.  See
%   also DIRECT.
% Version: 2014-07-07
% Usage:   [az,va,d]=inverse(lat1,lon1,h1,lat2,lon2,h2,a,e2)
...
% reference ellipsoid that is used in the traditional inverse
