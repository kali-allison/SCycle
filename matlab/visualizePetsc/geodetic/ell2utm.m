...
% Version: 2014-03-02
% Usage:   [N,E,Zone,lcm]=ell2utm(lat,lon,a,e2,lcm)
...
% Revised 2013-07-27 Corrected vectorized computation of E2
% Revised 2014-03-02 Improved Zone computation and added correction for
%                    non-existent zero Zone
...
if nargin == 3 | nargin==5
  ...
  %Zone=floor((rad2deg(lon)-180)/6)+1;  % Method 1 original
  Zone=floor(rad2deg(lon)/6)+31;        % Method 2 Goudarzi (faster)
